...
SEM = CFG.SEM;
ERP = pop_ploterps(ERP, CFG.ERP_bins,  16:ERP.nchan, 'AutoYlim', 'off', 'yscale', amplitude_limit, 'Axsize', [ 0.05 0.08], 'BinNum', 'on', 'Blc', 'pre', 'Box', [ 6 6], 'ChLabel',...
    'on', 'FontSizeChan',  10, 'FontSizeLeg',  12, 'FontSizeTicks',  10, 'LegPos', 'bottom', 'Linespec', {'r-', 'b-', 'g-'}, 'LineWidth',  1, 'Maximize',...
